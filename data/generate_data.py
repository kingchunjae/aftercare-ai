...
# ── 지역돌봄기관 참여율 범위 (지역아동센터·아이돌봄서비스·드림스타트 등)
...
# ── 돌봄 수요 해소 기여 가중치
# 방과후학교: 방과 후 2-4시간 교육·체험, 돌봄교실의 부분 대체
#   → 1명 참여 = 돌봄교실 0.35명분 수요 해소
# 지역돌봄기관(지역아동센터·아이돌봄·드림스타트): 종일 운영, 취약계층 집중
...
for r in REGIONS:
    ...
    # ── 지역돌봄기관 참여인원 추정 (지역아동센터·아이돌봄서비스·드림스타트 등)
    ...
    #   - 지역돌봄기관(지역아동센터·아이돌봄·드림스타트): 종일 운영, 취약계층 집중 → 가중치 0.40
